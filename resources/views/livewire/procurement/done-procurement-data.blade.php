    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-12 sm:align-middle sm:max-w-screen-lg sm:w-full"
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <span class="mt-3 ml-2 flex w-full rounded-md shadow-sm sm:mt-0 sm:w-auto">
                    <button wire:click="storeProcurementProductToInventory()" type="button"
                        class="inline-flex justify-center w-full rounded-md border border-sky-300 px-4 py-2 bg-sky-600 text-base leading-6 font-bold text-white shadow-sm hover:bg-sky-800 hover:bg-grey-300 focus:outline-none focus:border-sky-300 focus:shadow-outline-sky transition ease-in-out duration-150 sm:text-sm sm:leading-5">
                        <svg wire:loading.delay wire:target="storeProcurementProductToInventory" class="w-5 h-5 mr-3 -ml-1 text-white animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                ...
                <span class="mt-3 flex w-full rounded-md shadow-sm sm:mt-0 sm:w-auto">
                    <button wire:click="cancelProcurement" type="button"
