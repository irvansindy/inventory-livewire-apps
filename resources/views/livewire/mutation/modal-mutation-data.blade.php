            ...
            <form>
                ...
                <div class="mb-4 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div>
                        ...
                        <div class="mb-4">
                            <label for="productInventoryIdArray" class="block text-gray-700 text-sm font-bold mb-2">Inventories</label>
                            <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="productInventoryIdArray" id="productInventoryIdArray" wire:model="productInventoryIdArray" multiple>
                            ...
                            @error('productInventoryIdArray') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
