                    ...
                    <div class="">
                        ...
                        <div class="grid grid-cols-2">
                            <div class="mb-4 mr-1">
                                ...
                                @else
                                    <select x-model="dataSelected" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="locationInventoryNameNow" id="locationInventoryNameNow" wire:model="locationInventoryNameNow">
                                        @foreach ($allDataLocation as $location)
                                            <option value="{{ $location->id }}">{{ $location->officeName }}</option>
                                        @endforeach
                                    </select>
                                    Inventory : <span x-text="dataSelected"></span>
                                @endif
