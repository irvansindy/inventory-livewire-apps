<div class="flex space-x-1 justify-around">
    {{-- <a href="{{ route('products.show', [$productName]) }}" target="_blank" class="p-1 text-teal-600 hover:bg-teal-600 hover:text-white rounded">
    ...
    <x-modal :value="$id">
        ...
        <h1 class="text-2xl text-purple-700">{{ $productName }}</h1>
    </x-modal>
