                            ...
                            <tbody>
                                <div>
                                    <tr>
                                        ...
                                        <td class="px-4 py-2">{{ $this->placementNumber }}</td>
                                    </tr>
                                    <tr>
                                        <td class="px-4 py-2">Date</td>
                                        <td class="px-4 py-2">:</td>
                                        <td class="px-4 py-2">{{ $this->placementDate }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-2">:</td>
                                        <td class="px-4 py-2">{{ $this->placementType }}</td>
                                    </tr>
                                </div>
                            </tbody>
                        </table>                        
                        ...
                        <table class="table-auto font-medium">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2">:</td>
                                    <td class="px-4 py-2">{{ $this->placementDescription }}</td>
                                </tr>
                                <tr>
